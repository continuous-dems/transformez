...
- **Applying a shift grid to your own data?** Read the [sign conventions](methodology.md#the-datum-shift-sign-conventions) first — the shift grid is always **added**, and the reasoning is not what most people expect.
